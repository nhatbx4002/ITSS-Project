  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        ...
        <Button onClick={() => setIsAddDialogOpen(true)} className="bg-[#1a1a6c] cursor-pointer">
              ...
              <CardContent className="pt-6 flex-grow">
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <p className="text-gray-500 text-sm">{m.duration} days</p>
                  </div>
                </div>
                <div className="mt-4">
        ...
        <DialogContent>
          <form onSubmit={handleSubmit}>
            ...
            <DialogFooter>
              ...
              <Button type="submit" className="cursor-pointer">Add Package</Button>
            </DialogFooter>
          </form>
        </DialogContent>
      </Dialog>
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        <DialogContent>
          ...
          <DialogFooter>
            ...
            <Button onClick={handleUpdate} className="cursor-pointer">Save Changes</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
