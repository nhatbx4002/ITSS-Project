...
export default function Sidebar() {
  ...
  const navItems: NavItem[] = [
    ...
    { icon: Package, label: "Inventory", href: "/staff/inventory" },
    { icon: Users, label: "Members", href: "/staff/members" },
    { icon: Dumbbell, label: "Coaches", href: "/staff/coaches" },
    { icon: BarChart2, label: "Feedback", href: "/staff/feedback" },
    { icon: Contact, label: "Memberships", href: "/staff/member_ships" },
  ]
